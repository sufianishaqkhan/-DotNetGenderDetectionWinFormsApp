...
namespace GenderDetectionWinFormsApp
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string faceProto = Path.GetFullPath("D:\\Projects\\GenderDetectionWinFormsApp\\GenderDetectionWinFormsApp\\models\\deploy.prototxt");
            string faceModel = Path.GetFullPath("D:\\Projects\\GenderDetectionWinFormsApp\\GenderDetectionWinFormsApp\\models\\res10_300x300_ssd_iter_140000_fp16.caffemodel");
            string ageProto = Path.GetFullPath("D:\\Projects\\GenderDetectionWinFormsApp\\GenderDetectionWinFormsApp\\models\\age_deploy.prototxt");
            string ageModel = Path.GetFullPath("D:\\Projects\\GenderDetectionWinFormsApp\\GenderDetectionWinFormsApp\\models\\age_net.caffemodel");
            string genderProto = Path.GetFullPath("D:\\Projects\\GenderDetectionWinFormsApp\\GenderDetectionWinFormsApp\\models\\gender_deploy.prototxt");
            string genderModel = Path.GetFullPath("D:\\Projects\\GenderDetectionWinFormsApp\\GenderDetectionWinFormsApp\\models\\gender_net.caffemodel");
            //string genderProto = Path.GetFullPath("D:\\Projects\\GenderDetectionWinFormsApp\\GenderDetectionWinFormsApp\\models\\data.vision.gender.prototxt");
            //string genderModel = Path.GetFullPath("D:\\Projects\\GenderDetectionWinFormsApp\\GenderDetectionWinFormsApp\\models\\data.vision.gender.caffemodel");
